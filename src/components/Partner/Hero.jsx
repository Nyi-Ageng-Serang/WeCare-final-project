import partner from "../../assets/kolaborasi.jpg";

function HeroPartner() {
  return (
    <div className="w-full py-6">
      <div className="container mx-auto px-10 lg:mt-10">
        <div className="flex flex-col lg:flex-row justify-between gap-20 items-center tracking-normal">
          {/* Partner Text */}
