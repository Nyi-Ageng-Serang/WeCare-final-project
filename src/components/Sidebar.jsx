...
function Sidebar() {
  return (
    <aside className="w-56 h-screen bg-[#FFB1B1] text-[#921A40] flex flex-col rounded-r-[2rem]">
      ...
      {/* Button Exit */}
      <button className="flex items-center space-x-6 py-3 px-6 mt-auto hover:bg-[#921A40] hover:bg-opacity-80 hover:text-white rounded-br-[2rem]">
